...
import com.sarriaroman.billing.C.PurchaseState;
import com.sarriaroman.example.classes.Commons;
import com.sarriaroman.utils.Base64;
import com.sarriaroman.utils.Base64DecoderException;
...
public class BillingSecurity {
		...
		private static final String PUBLIC_KEY = "YOUR KEY HERE";
        ...
        public static ArrayList<VerifiedPurchase> verifyPurchase(String signedData, String signature) {
                ...
                if (!TextUtils.isEmpty(signature)) {
                         ...
                         */
                        String base64EncodedPublicKey = BillingSecurity.PUBLIC_KEY;
