...
import com.sarriaroman.billing.C.ResponseCode;
...
public class BillingHelper {
        ...
        public static void setCompletedListener(PurchaseListener handler){
                listener = handler;
        }
        ...
        private static void startBuyPageActivity(PendingIntent pendingIntent, Intent intent, Context context){
         ...
         protected static void verifyPurchase(String signedData, String signature) {
                ...
                if(listener != null){
                        ...
                        listener.purchaseCompleted(latestPurchase);
                } else {
        ...
        public static void stopService(){
                mContext.stopService(new Intent(mContext, MarketBillingService.class));
                mService = null;
                mContext = null;
                listener = null;
